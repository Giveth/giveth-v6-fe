  ...
  return (
    <div className="rounded-3xl bg-white p-6 shadow-sm">
      ...
      <div className="mb-6 rounded-xl border border-gray-100 p-4">
        ...
        <a
          href="#"
          className="text-xs font-medium text-[#fd67ac] hover:underline"
        >
      ...
      <button
        ...
        disabled={inCart}
        className={`flex w-full items-center justify-center gap-2 rounded-full py-3 text-sm font-bold text-white transition-colors ${
          inCart
