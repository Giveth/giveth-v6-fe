            ...
            <div className="px-4 py-3">
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#ebecf2]">
                  <div className="w-4 h-4 rounded-full bg-[#37b4a9] flex items-center justify-center">
                  ...
                  {round.transactions.map(tx => (
                    <div key={tx.id} className="flex items-center gap-3 py-2">
                      ...
                      <div className="relative group">
                        <span className="text-sm text-[#5326ec] cursor-pointer hover:underline">
                          {tx.amount} ({tx.usdValue})
                        </span>
                        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-[#1f2333] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50">
                          View Tx
                        </div>
                      </div>
