    ...
    return (
        <header className="sticky top-0 z-50 flex h-20 items-center justify-between bg-white px-4 shadow-sm sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-4">
                <Link href="#" className="hidden text-sm font-bold text-[#d81a72] hover:text-[#b0155c] sm:block">
                    Create A Project
                </Link>
                ...
                <button className="relative flex h-10 w-10 items-center justify-center rounded-full bg-gray-50 hover:bg-gray-100">
                    ...
                    <span className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-[#fd67ac] text-[10px] font-bold text-white">12</span>
                </button>

                <Link href="/donation" className="flex items-center gap-2 rounded-full bg-white px-4 py-2 shadow-sm ring-1 ring-gray-200 hover:bg-gray-50">
                ...
                <div className="hidden items-center gap-2 rounded-full bg-white px-3 py-1.5 shadow-sm ring-1 ring-gray-200 sm:flex">
                    ...
                    <div className="flex flex-col">
                        <span className="text-xs font-bold text-gray-900">0xF278...7a2cc</span>
                        <span className="text-[10px] text-[#1b1657]">Connected to xDai</span>
                    </div>
                </div>
            </div>
        </header>
